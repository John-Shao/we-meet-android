...
val meetingCaptureTranslation = cfg("WE_MEET_CAPTURE_TRANSLATION_NATIVE", "false").toBoolean().toString()
...
android {
    ...
    defaultConfig {
        ...
        buildConfigField("boolean", "WE_MEET_CAPTURE_TRANSLATION_NATIVE", meetingCaptureTranslation)
