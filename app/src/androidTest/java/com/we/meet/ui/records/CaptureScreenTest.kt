...
class CaptureScreenTest {
    ...
    @Test fun longTranscriptKeepsPauseAndFinishVisibleAndAudioModeLocked() {
        ...
        compose.onNodeWithContentDescription(label(R.string.capture_tool_interpret)).performClick()
        screenshot("interpretation")
        compose.onNodeWithContentDescription(label(R.string.records_close)).performClick()
        compose.onNodeWithContentDescription(label(R.string.capture_tool_translate)).performClick()
