...
enum class MeetingIntentKind { OVERVIEW_REQUEST, CAPTURE_ASR, SUMMARY_REQUEST, SUMMARY_AUTOMATION, HUMAN_REVIEW, SUMMARY_TASK, RECORD_QUESTION, DOCUMENT_EXPORT, DOCUMENT_EXPORT_RETRY, SUMMARY_NOTICE_RETRY, SUMMARY_SHARE, ONLINE_CAPTURE, PRIVATE_TRANSLATION, INTERPRETATION_CHANNEL, INTERPRETATION_LISTEN, CLOUD_RECORDING, CAPTURE_TRANSLATION, TRANSCRIPT_REPLACEMENT, RECORD_COLLABORATION, MINUTES_COLLABORATION }
