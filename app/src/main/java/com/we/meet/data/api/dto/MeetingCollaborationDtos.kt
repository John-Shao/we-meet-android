...
data class MaterialPersonDto(val id: String, val name: String)
data class MaterialCandidatesDto(val results: List<MaterialPersonDto>, @Json(name = "next_offset") val nextOffset: Int? = null)
